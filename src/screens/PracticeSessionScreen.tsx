...
const styles = StyleSheet.create({
  ...
  input: { borderRadius: 18, borderWidth: 2, borderBottomWidth: 3.5, fontSize: 17.5, minHeight: 56, paddingHorizontal: 16 },
  hintAction: { alignItems: 'center', flexDirection: 'row', gap: 7, minHeight: 48 },
  hint: { alignItems: 'center', borderRadius: 18, borderWidth: 2, borderBottomWidth: 3.5, flexDirection: 'row', gap: 11, marginVertical: 10, padding: 14 },
  helpRow: { flexDirection: 'row', gap: 9, marginVertical: 9 },
  helpAction: { alignItems: 'center', borderRadius: 16, borderWidth: 2, borderBottomWidth: 3.5, flex: 1, flexDirection: 'row', gap: 8, justifyContent: 'center', minHeight: 46, paddingHorizontal: 10 },
  primary: {
    alignItems: 'center',
    borderRadius: 20,
    borderWidth: 2,
  ...
  feedbackHead: { alignItems: 'center', borderRadius: 18, borderWidth: 2, borderBottomWidth: 3.5, flexDirection: 'row', gap: 10, padding: 14 },
  explanation: { lineHeight: 22 },
  resultPage: { gap: 15, paddingBottom: 28, paddingTop: 8 },
  resultHero: { alignItems: 'center', borderRadius: 24, borderWidth: 2, borderBottomWidth: 5.5, flexDirection: 'row', gap: 20, padding: 22 },
  ...
  resultFact: { borderRadius: 18, borderWidth: 2, borderBottomWidth: 3.5, flex: 1, padding: 13 },
  ...
  reviewIcon: { alignItems: 'center', borderRadius: 14, borderWidth: 1.5, height: 42, justifyContent: 'center', width: 42 },
