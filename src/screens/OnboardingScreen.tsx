...
const styles = StyleSheet.create({
  ...
  mascot: { alignItems: 'center', borderRadius: 20, borderWidth: 3, borderBottomWidth: 6, borderColor: '#E5B200', height: 60, justifyContent: 'flex-end', overflow: 'hidden', width: 60 },
  ...
  benefitIcon: { alignItems: 'center', borderRadius: 16, borderWidth: 3, borderBottomWidth: 4, height: 48, justifyContent: 'center', width: 48 },
  ...
  selectionIcon: { alignItems: 'center', borderRadius: 18, borderWidth: 3, borderBottomWidth: 5, height: 52, justifyContent: 'center', width: 52 },
  profileNumber: { alignItems: 'center', borderRadius: 18, borderWidth: 3, borderBottomWidth: 5, height: 48, justifyContent: 'center', width: 48 },
})
