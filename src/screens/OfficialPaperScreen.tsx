...
const styles = StyleSheet.create({
  ...
  workInput: { borderRadius: 18, borderWidth: 2, borderBottomWidth: 3.5, fontSize: 14.5, lineHeight: 22, marginTop: 15, minHeight: 110, padding: 14, textAlignVertical: 'top' },
  helpActions: { flexDirection: 'row', gap: 9, marginTop: 14 },
  secondary: { alignItems: 'center', borderRadius: 16, borderWidth: 2, borderBottomWidth: 3.5, flex: 1, flexDirection: 'row', gap: 7, justifyContent: 'center', minHeight: 46, paddingHorizontal: 9 },
  helpBox: { borderRadius: 18, borderWidth: 2, borderBottomWidth: 3.5, marginTop: 12, padding: 15 },
  helpCopy: { lineHeight: 20, marginTop: 5 },
  solutionToggle: { alignItems: 'center', borderRadius: 16, borderWidth: 2, borderBottomWidth: 3.5, flexDirection: 'row', justifyContent: 'space-between', marginTop: 14, minHeight: 50, paddingHorizontal: 14 },
  bottom: { borderTopWidth: 1.8, flexDirection: 'row', flexWrap: 'wrap', gap: 10, paddingTop: 10 },
  submitWarning: { borderRadius: 12, borderWidth: 1.5, padding: 10, width: '100%' },
  navButton: { alignItems: 'center', borderRadius: 16, borderWidth: 2, borderBottomWidth: 3.5, height: 50, justifyContent: 'center', width: 50 },
  finishButton: { alignItems: 'center', borderRadius: 18, borderWidth: 2, borderBottomWidth: 4.5, flex: 1, flexDirection: 'row', gap: 8, justifyContent: 'center', minHeight: 50 },
  primary: { alignItems: 'center', borderRadius: 20, borderWidth: 2, borderBottomWidth: 5, flexDirection: 'row', gap: 9, justifyContent: 'center', minHeight: 54 },
  resultPage: { gap: 15, justifyContent: 'center', paddingBottom: 50 },
  resultCard: { borderRadius: 24, borderWidth: 2, borderBottomWidth: 5.5, padding: 22 },
