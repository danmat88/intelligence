...
const styles = StyleSheet.create({
  ...
  chromeGhost: { width: 44, height: 44 },
  ...
  discInner: { width: 28, height: 28, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  solveLbl: { flex: 1, letterSpacing: -0.2 },
  solveArrow: { opacity: 0.9 },
})
