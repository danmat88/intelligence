...
const styles = StyleSheet.create({
  wrap: { flex: 1, backgroundColor: '#08080C', alignItems: 'center', justifyContent: 'center', padding: 32, gap: 12 },
  title: { color: '#F4F5FA', fontSize: 22, fontWeight: '700' },
  body: { color: '#A2A6B6', fontSize: 15, textAlign: 'center', lineHeight: 22, maxWidth: 320 },
  btn: { marginTop: 12, backgroundColor: '#6366F1', borderRadius: 999, paddingHorizontal: 28, paddingVertical: 14 },
